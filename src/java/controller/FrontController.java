...
public class FrontController extends HttpServlet {
    ...
    private void doPostLogin(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        if ((status == true) && (usuario.getSenha().equals(usuarioTry.getSenha())))
        {
            ...
            //true crie uma seção se não houver alguma, false do contrario
            
            //informações armazenadas no servidor
            HttpSession sessao = request.getSession(false);
            if(sessao != null){
                //se a sessao já existir
                sessao.invalidate();
            }
            ...
            request.setAttribute("msg", "Id e/ou senha invalida(s)");
